import pytest
from app.matching.evidence import collect_skills_evidence, InternalEvidenceResult, map_to_public
from app.schemas.match_report import MatchLevel, EvidenceResult
from app.schemas.parsed_jd import VerifiedJD, VerifiedJDField
from app.schemas.parsed_resume import VerifiedParsedResume, VerifiedField, VerifiedEducation, VerifiedContact
...
def mock_jd(req_skills):
    return VerifiedJD(
        ...
        required_skills=[VerifiedJDField(value=s, verification_state="Verified") for s in req_skills],
        preferred_skills=[],
        responsibilities=[],
        qualifications=[],
        experience_requirements=VerifiedJDField(value="3 years", verification_state="Verified"),
        education_requirements=VerifiedJDField(value="BS", verification_state="Verified"),
