...
from app.matching.evidence import collect_experience_evidence, collect_skills_evidence
...
jd = VerifiedJD(
    ...
    required_skills=[
        ...
        VerifiedJDField(
            value="Object-oriented programming", verification_state="Verified"
        ),
        VerifiedJDField(
            value="Software development fundamentals", verification_state="Verified"
        ),
        ...
        VerifiedJDField(
            value="Scalable software architecture", verification_state="Verified"
        ),
    ],
    preferred_skills=[],
    responsibilities=[],
    ...
    education_requirements=VerifiedJDField(
        value="BS Computer Science", verification_state="Verified"
    ),
...
resume = VerifiedParsedResume(
    ...
    summary=VerifiedField(
        value="Experienced backend developer with strong foundations in API design and databases.",
    ...
    experience=[
        VerifiedExperience(
            title=VerifiedField(
                value="Software Engineering Intern", verification_state="Verified"
            ),
            ...
            responsibilities=[
                VerifiedField(
                    value="Developed scalable web services using Java and Spring Boot.",
                    verification_state="Verified",
                ),
                VerifiedField(
                    value="Optimized PostgreSQL queries improving performance by 20%.",
                    verification_state="Verified",
                ),
            ],
        )
    ...
    education=[
        VerifiedEducation(
            degree=VerifiedField(value="BS Computer Science", verification_state="Verified"),
            institution=VerifiedField(value="Tech University", verification_state="Verified"),
